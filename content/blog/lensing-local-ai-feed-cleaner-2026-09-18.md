...
```
 Host page — https://x.com                Extension origin — chrome-extension://
┌───────────────────────────┐            ┌────────────────────────────────────┐
│ feed DOM                   │            │ hidden iframe (routes messages)     │
│   │ post text               │            │       │                            │
│   ▼                        │   texts    │       ▼                            │
│ content script              │ ────────▶ │ worker thread                       │
│ finds posts, applies        │            │  e5-small-v2: embed the text,      │
│ the blur to .lx-blur        │ ◀──────── │  cosine similarity vs your topics   │
└───────────────────────────┘   scores    └────────────────────────────────────┘
```
